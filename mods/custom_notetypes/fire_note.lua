function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'fire_note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'fire_note'); --Change texture --Change note splash texture
