...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(!closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/CrusherMods/respect-funkin/main/gitVersion.txt");
			
			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.respectVersion.trim();
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['A mod by'], -60);
				case 7:
					addMoreText('a small of peoples', -60);
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				// credTextShit.visible = false;
				...
				// credTextShit.visible = true;
				case 14:
					addMoreText('Look in the credits');
				// credTextShit.text += '\nNight';
				case 15:
				...
				case 16:
					deleteCoolText();
				case 17:
					addMoreText('Give me some robux');
				case 18:
                    addMoreText("I'm poor");
				case 19:
					deleteCoolText();
				case 20:
					createCoolText(['Respect']);
				case 21:
					addMoreText("Funkin'");
